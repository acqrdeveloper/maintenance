            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="form-group-sm col-sm-6">
                            ...
                            <input name="quantity" type="text" class="form-control input-sm" value="{{ old('quantity') }}">
                        </div>
                        <div class="form-group-sm col-sm-6">
                    ...
                    <div class="form-group-sm">
                        <label for="" class="control-label">load image
                        </label>
                        <input name="image" type="file" class="form-control input-sm" value="{{ old('image') }}">
                    </div>
                    <div class="form-group-sm">
                        <label for="" class="control-label">description</label>
                        <textarea name="description" type="text" class="form-control input-sm">{{ old('description') }}</textarea>
                    </div>
                </div>
                <div class="panel-body row">
                    ...
                    <div class="col-sm-6 text-right">
                        ...
                        <button type="reset" class="btn btn-sm btn-default myBtnHoverDanger"><span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;cancel
                        </button>
                    </div>
